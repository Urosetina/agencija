...
public class Agencija {
	...
	public void daLiImaDovojlnoNovcaUBudzetu(double ukupniTroskovi, double budzet) {
		
		double ostatak = budzet - ukupniTroskovi;
		
	if(ostatak > 0) {System.out.println("Ima jos " + ostatak + " novca u budzetu!");
		}else {System.out.println("U minusu smo " + ostatak);}
	}
